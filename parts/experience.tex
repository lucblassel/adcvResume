...
\begin{adcvtabletwo}
	...
	\else
		\adcvrowmulti{Improve the accuracy of predicted distances and develop the architecture of the model to accept unaligned sequences as input for the \href{https://github.com/lucanest/Phyloformer}{PhyloFormer} project. Work with \href{https://scholar.google.com/citations?user=54bOCmQAAAAJ\&hl=en\&oi=ao}{Laurent Jacob}.}
	\fi
