...
\begin{adcvtabletwo}
	\adcvrowtwo{\textbf{Post-Doctoral Researcher}, \href{https://lcqb.fr}{Sorbonne Université}, Paris, France}{2023--}
	\ifextended%
		\adcvrowmulti{
			During this postdoc I will work on the \href{https://github.com/lucanest/Phyloformer}{PhyloFormer} project with \href{https://scholar.google.com/citations?user=54bOCmQAAAAJ\&hl=en\&oi=ao}{Laurent Jacob} and members of the LBBE in Lyon. I am working on improving performance of the model as well as it's generalisation. Extensions to the model are planned, such as taking unaligned sequences as input and including a differentiable tree-building step in an end-to-end pipeline.
		}
	\else
		\adcvrowmulti{Likelihood-free inference of phylogenetic trees within the \href{https://github.com/lucanest/Phyloformer}{PhyloFormer} project. Work with \href{https://scholar.google.com/citations?user=54bOCmQAAAAJ\&hl=en\&oi=ao}{Laurent Jacob} at the CQSB.}
	\fi

	\adcvrowskip%

	\adcvrowtwo{\textbf{Doctoral candidate}, \href{https://www.pasteur.fr/en}{Institut Pasteur}, Paris, France}{2020--2023}
	\ifextended%
		\adcvrowmulti{
