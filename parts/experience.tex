...
\begin{adcvtabletwo}
  ...
  \ifextended%
    \adcvrowmulti{
      During this postdoc I will work on the \href{https://github.com/lucanest/Phyloformer}{phyhloformer} project with \href{https://scholar.google.com/citations?user=54bOCmQAAAAJ\&hl=en\&oi=ao}{Laurent Jacob} and members of the LBBE in Lyon. My work will center around improving the performacne of the model, making it's output closer to the real phylogenetic tree. I will also be adding funcitonality to the model, mainly the ability to take unaligned sequences as input. 
    }
  \else
